...
/* @MapperScan = mapper위치가 아예 찾아지지 않을 때 main메서드에 Mapper 주소를 작성해주는 어노테이션
 * 사용법
 * @MapperScan("com.khmall.mapper.loginMapper") 하나의매퍼 가져오기
...
public interface loginMapper {
	...
	//insert와 update는 void다!
	void updateMember(Member member);
	
	//insert와 update와 delete는 void!!!!
