...
public class GoodsItemService {
	...
	*/
	...
	public boolean existsByName(String itemName) {
		...
		//Integer count = goodsItemMapper.exitsByName(itemName); ->resultMap 사용X 방식
		
		GoodsItem count = goodsItemMapper.existsByName(itemName); //resultMap 사용O 방식
